       ...
       <div className="container-fluid bg-dark text-white min-vh-100">
        <div className="row">
          ...
          <div className="col-12 d-flex justify-content-between align-items-center py-3 px-4 border-bottom">
            <h2 className="text-primary m-0">Enquiry Portal</h2>
          ...
          <div className="col-sm-4 col-lg-3 text-white">
            <ul className="sidebar">
              ...
              <li>
                <Link className="text-warning" to="enqdata">Quick Enquiry</Link>
              </li>
              <li>
                <Link className="text-warning" to="condata">Contact us</Link>
              </li>
            </ul>
          </div>

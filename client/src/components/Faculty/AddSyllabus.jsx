...
const AddSyllabus = () => {
  ...
  let syllabusURL='http://127.0.0.1:8000/api/syllabus/';
      ...
      <div className="fluid">
        <div className="row">
          <div className="col-12 text-white">
            <h4 className='text-center bg-success  text-light p-2 rounded p-1 '>Add Syllabys</h4>
            <form action="" className='bg-secondary p-2 rounded '  onSubmit={submitHandler}>
              <div>
              ...
              <div>
                <label htmlFor="course" className='mx-2'>Year</label>
                <select name="year" id="course" className="form-control" onChange={inputHandler}>

      ...
      <div className="container-fluid bg-dark text-white min-vh-100">
        <div className="row">
          ...
          <div className="col-12 d-flex justify-content-between align-items-center py-3 px-4 border-bottom">
            <h2 className="text-primary m-0">Performer Portal</h2>
...
/**
 * model
 * take basic information form the student model
 * result(name,course,grade,profile, percentage, email status, batch)
 * 
 * placement 
 * take basic information form the student model 
 * placement (name, comany, sector gov/pvt , profile , package,)
 */

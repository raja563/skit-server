      ...
      <div className="container-fluid bg-dark text-white min-vh-100">
        <div className="row">
          ...
          <div className="col-12 d-flex justify-content-between align-items-center py-3 px-4 border-bottom">
            <h2 className="text-primary m-0">Gallery Portal</h2>
...
/*
  infra(category-ground/lab/lib/classroom, profile, desc, number)
  infra(category-function-type/day's/sports/social, profile, desc, number)
  video(video,function,desc,date)
*/
